using wineo.Application.Common.Behaviours;
using wineo.Application.Common.Interfaces;
using wineo.Application.TodoItems.Commands.CreateTodoItem;
using Microsoft.Extensions.Logging;
using Moq;
using NUnit.Framework;

namespace wineo.Application.UnitTests.Common.Behaviours;
